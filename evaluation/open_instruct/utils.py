...
# 1. 定义一个假的 VllmConfig 类，专门用来应付类型检查
...
vllm.config.VllmConfig = DummyVllmConfig  # 关键：把这个类挂载上去

# 3. 如果后面还有类似 vllm.SamplingParams 的报错，可以预判性加上：
vllm.SamplingParams = DummyVllmConfig 
# ======================
